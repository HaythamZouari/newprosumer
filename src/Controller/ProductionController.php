...
class ProductionController extends AbstractController
{
    ...
    public function pvgis(LoggerInterface $logger,EventDispatcherInterface $eventDispatcher, Project $project, Request $request)
    {
        ...
        $period = CarbonPeriod::create('2017-01-01 00:00','PT1H','2017-12-31 23:00','UTC' /*, CarbonPeriod::EXCLUDE_START_DATE*/);
        $i=2;
    ...
    $period = CarbonPeriod::create('2014-01-01 00:00','PT1H','2014-12-31 23:00','UTC' /*, CarbonPeriod::EXCLUDE_START_DATE*/);
    $i=0;
    foreach ($period as $key=>$date) {
        /*$string=$array[$i][0];*/
